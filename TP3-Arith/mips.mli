...
type register
(** Type abstrait pour les registres et constantes pour chacun des
    registres *)
...
(** [push r] place le contenu de [r] au sommet de la pile. $sp pointe
...
(** Le programme ci-dessous donné à gauche en pur MIPS et à droite en
    OCaml charge deux constantes, effectues quelques opérations
